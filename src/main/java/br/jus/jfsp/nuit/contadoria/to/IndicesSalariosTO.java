...
import br.jus.jfsp.nuit.contadoria.controllers.IndicesSalariosController;
...
public class IndicesSalariosTO
        extends BaseTO<IndicesSalariosTO>
    ...
    public IndicesSalariosTO apply() throws RecordNotFoundException {
        add(linkTo(methodOn(IndicesSalariosController.class).read(id)).withSelfRel());
        return this;
    }
